...
window.geometry("323x405")
window.config(bg=color1)

# Fremes
frameDisplay = Frame(window, width=323, height=120, bg=color1)
frameDisplay.grid(row=0, column=0)

frameKeyboard = Frame(window, width=323, height=260, bg=color1)
...
labelFooter = Label(frameFooter, text="V.: 1.2.3", bg=color1, fg=color2, font=("Ivy 9"), width=44, padx=8, justify="right", anchor="e")
labelFooter.pack()
